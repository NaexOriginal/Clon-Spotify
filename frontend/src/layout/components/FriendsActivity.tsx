...
const LoginPrompt = () => (
  <div className="h-full flex  flex-col items-center justify-center p-6 text-center space-y-4">
    ...
    <div className="space-y-2 max-w-[250px]">
      <h3 className="text-lg font-semibold text-white">Mira que Escuchan tus Amigos</h3>
      <p className="text-sm text-zinc-400">Inicia sesión para descubir la música que disfrutan tus amigos ahora mismo</p>
    </div>
  </div>
);
...
export const FriendsActivity = () => {
  ...
  return (
    <div className="h-full rounded-lg bg-zinc-900 flex flex-col">
      <div className="p-4 flex justify-between items-center border-b border-zinc-800">
        <div className="flex items-center gap-2">
          <Users className="size-5 shrink-0" />
          <h2 className="font-semibold">¿Que estan escuchando?</h2>
        </div>
          ...
          { users.map((user) => (
            ...
            >
              <div className="flex items-start gap-3">
                <div className="relative">
                  <Avatar className="size-10 border border-l-zinc-800">
                    <AvatarImage 
                      src={ user.imageUrl } 
                      alt={ user.fullName }
                    />
